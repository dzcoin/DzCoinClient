package org.dzcoinlab.test;

import com.google.gson.gson;
import org.json.jsonobject;
import org.dzcoinlab.api.apiexception;
import org.dzcoinlab.api.accountimpl;
import org.dzcoinlab.api.transactionimpl;
...
import org.dzcoinlab.core.currency;
...
/**
 * dzcoin network provides websocket interface to make tx. this is a test class for websocket api with dzcoin.
 * the config file is searched by order:
 *   1, {project_resources}/dzcoin.properties
 *   2, {project_resources}/dzcoin.properties
 *
...
public class testwebsocket {
    ...
    public void testsubscribe() {
        //step 1: send subscribe request to dzcoin, return immediately
        ...
        try {
            string subscribe = dzcoinwebsocketclient.request("{\n" +
                    "  \"id\": 10,\n" +
                    "  \"command\": \"subscribe\",\n" +
        ...
        while (count < 3) {
            ...
            try {
                ...
                string data = dzcoinwebsocketclient.subscribequeue.poll(5, timeunit.seconds);
                //if using take() method, there is not need of timeout. take() will block and wait until something is returned.
                //string data = dzcoinwebsocketclient.subscribequeue.take();
    ...
    public void testaccounttx() throws urisyntaxexception, interruptedexception {
        ...
        while(count < 2) {
            try {
                string resp = dzcoinwebsocketclient.request(data);
