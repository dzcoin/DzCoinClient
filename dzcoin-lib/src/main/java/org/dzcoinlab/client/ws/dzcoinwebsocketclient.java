...
import org.dzcoinlab.client.config;
...
/**
 * interact with dzcoin servers
 */
public class dzcoinwebsocketclient {
    ...
    private static final logger logger = logger.getlogger(dzcoinwebsocketclient.class);
