...
import org.dzcoinlab.core.hash.hash160;
...
//        system.out.println("vbc_1     : " + vbc_1.address);
    ...
    private static string encodeaddress(byte[] a) {
        if(a.length != 20)  // added by fau
            throw new dzcoinexception("encodeaddress() param length must be 20(ripemd160)!");
    ...
    static public accountid fromaddress(string address) throws dzcoinexception {
    ...
    public static accountid fromstring(string value) throws dzcoinexception {
