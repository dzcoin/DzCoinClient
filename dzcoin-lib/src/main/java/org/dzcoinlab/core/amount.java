package org.dzcoinlab.core;

import org.dzcoinlab.core.fields.field;
import org.dzcoinlab.core.fields.typedfields;
import org.dzcoinlab.core.serialized.binaryparser;
import org.dzcoinlab.core.serialized.bytessink;
import org.dzcoinlab.core.serialized.serializedtype;
import org.dzcoinlab.core.serialized.typetranslator;
...
/**
 * in dzcoin, amounts are either vrp/vbc, the native currency, or an iou of
 * a given currency as issued by a designated account.
 */
public class amount extends number implements serializedtype, comparable<org.dzcoinlab.core.amount>
...
//    public static final amount neutral_zero = new amount(currency.neutral, accountid.neutral);
    ...
    public static final org.dzcoinlab.core.amount one_vrp = fromstring("1.0");
    ...
    private org.dzcoinlab.core.amount newvalue(bigdecimal newvalue) {
        return newvalue(newvalue, false, false);
    }

    private org.dzcoinlab.core.amount newvalue(bigdecimal newvalue, boolean round, boolean unbounded) {
        if (round) {
    ...
    private org.dzcoinlab.core.amount newvalue(bigdecimal val, boolean round) {
    ...
    private boolean equalvalue(org.dzcoinlab.core.amount amt) {
        return compareto(amt) == 0;
    }
    @override
    public boolean equals(object obj) {
        if (obj instanceof org.dzcoinlab.core.amount) {
            return equals((org.dzcoinlab.core.amount) obj);
        }
        return super.equals(obj);
    }

    public boolean equals(org.dzcoinlab.core.amount amt) {
        return equalvalue(amt) &&
                currency.equals(amt.currency) &&
                (isnative() || issuer.equals(amt.issuer));
    }

    public boolean equalsexceptissuer(org.dzcoinlab.core.amount amt) {
        return equalvalue(amt) &&
    ...
    public int compareto(org.dzcoinlab.core.amount amount) {
    ...
    divide and multiply are equivalent to the javascript dzcoin-lib
    ratio_human and product_human.

    */
    public org.dzcoinlab.core.amount add(bigdecimal augend) {
        return newvalue(value.add(augend), true);
    }

    public org.dzcoinlab.core.amount add(org.dzcoinlab.core.amount augend) {
        return add(augend.value);
    }

    public org.dzcoinlab.core.amount add(number augend) {
        return add(bigdecimal.valueof(augend.doublevalue()));
    }

    public org.dzcoinlab.core.amount subtract(bigdecimal subtrahend) {
        return newvalue(value.subtract(subtrahend), true);
    }

    public org.dzcoinlab.core.amount subtract(org.dzcoinlab.core.amount subtrahend) {
        return subtract(subtrahend.value);
    }

    public org.dzcoinlab.core.amount subtract(number subtrahend) {
        return subtract(bigdecimal.valueof(subtrahend.doublevalue()));
    }

    public org.dzcoinlab.core.amount multiply(bigdecimal divisor) {
        return newvalue(value.multiply(divisor, math_context), true);
    }

    public org.dzcoinlab.core.amount multiply(org.dzcoinlab.core.amount multiplicand) {
        return multiply(multiplicand.value);
    }

    public org.dzcoinlab.core.amount multiply(number multiplicand) {
        return multiply(bigdecimal.valueof(multiplicand.doublevalue()));
    }

    public org.dzcoinlab.core.amount divide(bigdecimal divisor) {
        return newvalue(value.divide(divisor, math_context), true);
    }

    public org.dzcoinlab.core.amount divide(org.dzcoinlab.core.amount divisor) {
        return divide(divisor.value);
    }

    public org.dzcoinlab.core.amount divide(number divisor) {
        return divide(bigdecimal.valueof(divisor.doublevalue()));
    }

    public org.dzcoinlab.core.amount negate() {
        return newvalue(value.negate());
    }

    public org.dzcoinlab.core.amount abs() {
        return newvalue(value.abs());
    }
    public org.dzcoinlab.core.amount min(org.dzcoinlab.core.amount val) {
        return (compareto(val) <= 0 ? this : val);
    }
    public org.dzcoinlab.core.amount max(org.dzcoinlab.core.amount val) {
        return (compareto(val) >= 0 ? this : val);
    }

    /* offer related helpers */
    public bigdecimal computequality(org.dzcoinlab.core.amount toexchangethiswith) {
     ...
     * just `one`.
     */
    public org.dzcoinlab.core.amount one() {
        if (isnative()) {
            return one_vrp;
        } else {
    ...
    public static class translator extends typetranslator<org.dzcoinlab.core.amount> {
        @override
        public org.dzcoinlab.core.amount fromstring(string s) {
            return org.dzcoinlab.core.amount.fromstring(s);
        }

        @override
        public org.dzcoinlab.core.amount fromparser(binaryparser parser, integer hint) {
            bigdecimal value;
        ...
        @override
        public string tostring(org.dzcoinlab.core.amount obj) {
            return obj.stringrepr();
        }

        @override
        public jsonobject tojsonobject(org.dzcoinlab.core.amount obj) {
            return obj.tojsonobject();
        }

        @override
        public org.dzcoinlab.core.amount fromjsonobject(jsonobject jsonobject) {
            try {
    ...
    public org.dzcoinlab.core.amount newissuer(accountid issuer) {
        return new amount(value, currency, issuer);
    }

    // static constructors
    public static org.dzcoinlab.core.amount fromstring(string val) {
        if (val.contains("/")) {
    ...
    public static org.dzcoinlab.core.amount fromdropstring(string val) {
        bigdecimal drops = new bigdecimal(val).scalebypoweroften(-6);
        checkdropsvaluewhole(val);
        return new amount(drops);
    }

    public static org.dzcoinlab.core.amount fromioustring(string val) {
    ...
    @deprecated
    private static org.dzcoinlab.core.amount fromxrpstring(string valuestring) {
        bigdecimal val = new bigdecimal(valuestring);
        return new amount(val);
    }

    /**
     * @return a string representation as used by dzcoin json format
     */
