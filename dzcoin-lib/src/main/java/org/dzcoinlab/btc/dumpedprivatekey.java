...
import org.dzcoinlab.btc.account.versionedchecksummedbytes;
...
public class dumpedprivatekey extends versionedchecksummedbytes {
     ...
     */
    public dumpedprivatekey(int ver, string encoded) throws dzcoinexception {
        super(encoded);
        if (version != ver)
            throw new dzcoinexception("mismatched version number, trying to cross networks? " + version +
                    " vs " + ver);
    }
