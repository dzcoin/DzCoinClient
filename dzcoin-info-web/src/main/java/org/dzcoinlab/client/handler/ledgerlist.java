package org.dzcoinlab.client.handler;

import com.google.gson.gson;
import org.dzcoinlab.client.clientprocessor;
import org.dzcoinlab.client.util.convert;
import org.dzcoinlab.client.util.httpclient;
...
public class ledgerlist implements clientprocessor {
    ...
    private int getledger(int index) throws dzcoinexception {
        gson gson = new gson();
