package org.dzcoinlab.client.util;
...
public class httpclient {
    ...
    public static response post(string url, string data) throws dzcoinexception {
        ...
        try {
            ...
            throw new dzcoinexception("error when sending request, message:" + e.getmessage());
        }finally {
            if(conn != null){
                conn.disconnect();
            }
    ...
    public static response get(string url) throws dzcoinexception {
        httpurlconnection conn = null;
        try {
            url requesturl = new url(url);
            conn = (httpurlconnection) requesturl.openconnection();
