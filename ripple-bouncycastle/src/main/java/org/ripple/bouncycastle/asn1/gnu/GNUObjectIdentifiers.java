...
public interface gnuobjectidentifiers
{
    ...
    public static final asn1objectidentifier gnupg = new asn1objectidentifier("1.3.6.1.4.1.11591.2"); // gnupg (脛gypten)
    ...
    public static final asn1objectidentifier gnudzcoin = new asn1objectidentifier("1.3.6.1.4.1.11591.3"); // gnu dzcoin
